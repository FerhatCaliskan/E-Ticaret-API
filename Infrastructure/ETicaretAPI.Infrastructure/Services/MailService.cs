...
namespace ETicaretAPI.Infrastructure.Services
{
	public class MailService : IMailService
	{
		...
		public async Task SendPasswordResetMailAsync(string to, string userId, string resetToken)
		{
			...
			mail.AppendLine("\">Yeni şifre talebi için tıklayınız...</a></strong><br><br><span style=\"font-size:12px;\">NOT : Eğer ki bu talep tarafınızca gerçekleştirilmemişse lütfen bu maili ciddiye almayınız.</span><br><br><br>Mini E-Ticaret");
