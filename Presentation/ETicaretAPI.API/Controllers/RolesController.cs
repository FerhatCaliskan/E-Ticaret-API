...
namespace ETicaretAPI.API.Controllers
{
	...
	public class RolesController : ControllerBase
	{
		...
		[HttpGet]
		[AuthorizeDefinition(ActionType = ActionType.Reading, Definition = "Rolleri Görüntüle", Menu = "Roller")]
		...
		[HttpGet("{Id}")]
		[AuthorizeDefinition(ActionType = ActionType.Reading, Definition = "Id'ye Göre Rol Görüntüle", Menu = "Roller")]
		...
		[HttpPost]
		[AuthorizeDefinition(ActionType = ActionType.Writing, Definition = "Rol Oluştur", Menu = "Roller")]
		...
		[HttpPut("{Id}")]
		[AuthorizeDefinition(ActionType = ActionType.Updating, Definition = "Rol Güncelle", Menu = "Roller")]
		...
		[HttpDelete("{Id}")]
		[AuthorizeDefinition(ActionType = ActionType.Deleting, Definition = "Rol Sil", Menu = "Roller")]
